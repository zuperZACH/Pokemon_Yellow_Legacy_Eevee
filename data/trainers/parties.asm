...
BrunoData:
	db $FF, 56, POLIWRATH, 57, PRIMEAPE, 57, HITMONCHAN, 56, ONIX, 58, MACHAMP, 0
; Rematch
...
ErikaData:
	db $FF, 33, TANGELA, 31, BUTTERFREE, 34, VICTREEBEL, 35, VILEPLUME, 0
	db $FF, 41, TANGELA, 42, BUTTERFREE, 42, VICTREEBEL, 43, VILEPLUME, 0
	db $FF, 48, TANGELA, 48, BUTTERFREE, 49, VICTREEBEL, 49, EXEGGUTOR, 50, VILEPLUME, 0
; Rematch
	db $FF, 64, TANGELA, 64, VENUSAUR, 64, PARASECT, 64, EXEGGUTOR, 65, VICTREEBEL, 65, VILEPLUME, 0

KogaData:
	db $FF, 42, GOLBAT, 42, ARBOK, 41, TENTACRUEL, 43, VENOMOTH, 0
	db $FF, 49, MUK, 48, SCYTHER, 49, TENTACRUEL, 48, ARBOK, 50, VENOMOTH, 0
; Rematch
...
SabrinaData:
	db $FF, 49, MR_MIME, 50, KADABRA, 49, WIGGLYTUFF, 48, HYPNO, 50, ALAKAZAM, 0
	db $FF, 42, MR_MIME, 43, KADABRA, 42, WIGGLYTUFF, 43, ALAKAZAM, 0
; Rematch
...
Rival2Data:
; SS Anne 2F
	db $FF, 20, RATICATE , 22, WEEPINBELL, 21, SANDSHREW, 24, PIKACHU, 0
; Pokémon Tower 2F
	db $FF, 34, FEAROW, 32, MAGNEMITE, 33, HAUNTER, 32, WARTORTLE, 35, RAICHU, 0
	db $FF, 34, FEAROW, 32, SHELLDER, 33, CUBONE, 32, CHARMELEON, 35, RAICHU, 0
	db $FF, 34, FEAROW, 32, VULPIX, 33, NIDORINO, 32, IVYSAUR, 35, RAICHU, 0
; Silph Co. 7F
	db $FF, 43, PARASECT, 44, DODRIO , 43, KABUTOPS, 44, KADABRA, 46, RAICHU, 0
	db $FF, 43, VICTREEBEL, 44, CLOYSTER, 43, GYARADOS, 44, KADABRA, 46, RAICHU, 0
	db $FF, 43, MAGMAR, 44, PORYGON, 43, PRIMEAPE, 44, KADABRA, 46, RAICHU, 0
; Route 22
	db $FF, 55, RAICHU, 52, FEAROW, 52, EXEGGUTOR , 54, ARCANINE, 53, BLASTOISE, 54, ALAKAZAM, 0
	db $FF, 54, SCYTHER, 52, GOLDUCK, 54, ALAKAZAM, 52, MAROWAK, 53, CHARIZARD, 55, RAICHU, 0
	db $FF, 54, PIDGEOT, 54, ALAKAZAM, 52, NINETALES, 52, MACHAMP, 53, VENUSAUR, 55, RAICHU, 0
	
Rival3Data: 
; Champion's Room
	db $FF, 62, ARCANINE, 60, DODRIO, 62, EXEGGUTOR, 63, ALAKAZAM, 63, BLASTOISE, 65, RAICHU, 0
	db $FF, 62, CLOYSTER, 60, GYARADOS, 63, ALAKAZAM, 62, VICTREEBEL, 63, CHARIZARD, 65, RAICHU, 0
	db $FF, 63, ALAKAZAM, 60, FEAROW, 62, MACHAMP, 62, NINETALES, 63, VENUSAUR, 65, RAICHU, 0
; Rematch
...
AgathaData:
	db $FF, 57, GENGAR, 57, NINETALES, 58, ARBOK, 58, MAROWAK, 59, GENGAR, 0
; Rematch
	db $FF, 71, JYNX, 71, GYARADOS, 72, ALAKAZAM, 71, VENUSAUR, 72, ARBOK, 73, GENGAR, 0

LanceData:
	db $FF, 61, CHARIZARD, 60, GYARADOS, 61, SEADRA, 60, AERODACTYL, 62, DRAGONITE, 0
; Rematch
